...
const BALLOON_WISHES = [
  ...
  "May this year bring you exactly what you need.",
  "Cheers to another year of being wonderfully you.",
  "Hope your cake has the perfect frosting-to-cake ratio.",
  "May your dreams get a little louder this year.",
  "Wishing you naps, snacks, and zero notifications.",
  "May your coffee be strong and your week be short.",
  "Here's to less stress and more dancing in the kitchen.",
  "May you find joy in the smallest things today.",
  "Wishing you a whole year of good hair days.",
  "May your playlists always match your mood.",
  "Here's to more good books and cozy evenings.",
  "May your year be plot-twist free — the good kind, at least.",
  "Wishing you the confidence to always eat dessert first.",
  "May your happiness be loud and your worries be quiet.",
  "Here's to friendships that feel like home.",
  "May you laugh until your cheeks hurt this year.",
  "Wishing you the energy of someone who just found five dollars.",
  "May every candle wish come true, one by one.",
  "Here's to being unapologetically yourself, always.",
  "May your year be full of unexpected good news.",
  "Wishing you rest that actually feels restful.",
  "May you always find parking spots and good vibes.",
  "Here's to celebrating you today, and always.",
  "May this year treat you as well as you treat others.",
];
